                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img class="assets/img-profile rounded-circle" src="<?= base_url('sb2/img/undraw_profile.svg') ?>">
                        </a>
...
<div id="content">
    ...
    <div class="container-fluid" style="display: flex; justify-content: center; align-items: center;">
        ...
        <form action="<?= base_url('/barang/store') ?>" method="POST">
            <!-- <label>Nama Barang:</label>
>>>>>>> 1802d2fc467e9cd46c18defb6614087dd9f72de8
        <input type="text" name="nama_barang" id="nama_barang" required> -->

                        <label for="exampleInputEmail1" class="form-label">Jenis Barang</label>
                        <select class="form-select mb-3 form-control" aria-label="Default select example" style="width:850px;" name="jenis_barang" id="jenis_barang">
                            <option selected>Pilih Jenis Barang</option>
                            <option>Minyak Goreng</option>
                            <option>Sabun Mesin Cuci</option>
                        </select>

<<<<<<< HEAD
                        <label for="exampleInputEmail1" class="form-label">Merk</label>
                        <select class="form-select mb-3 form-control" aria-label="Default select example" style="width:850px;" name="merk_barang" id="merk_barang">
...
>>>>>>> 1802d2fc467e9cd46c18defb6614087dd9f72de8
                        ...
                        <div class="mb-3" style="width:850px;">
                            <label for="exampleInputEmail1" class="form-label">Jumlah Unit</label>
