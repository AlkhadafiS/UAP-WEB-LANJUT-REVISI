...
<body>
    <div class="dropdown-center">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?= base_url('/login') ?>">Super Admin</a></li>
            <li><a class="dropdown-item" href="<?= base_url('/login') ?>">Manager</a></li>
            <li><a class="dropdown-item" href="<?= base_url('/login') ?>">Warehouse Admin</a></li>
            <li><a class="dropdown-item" href="<?= base_url('/login') ?>">Cashier</a></li>
        </ul>
    </div>
